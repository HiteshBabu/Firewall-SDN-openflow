...
class router (EventMixin):
  def __init__ (self, arp_for_unknowns = False):
    ...
    self.routingTable={}
    #self.routingTable[2]={}
    self.routingTable[1] = [ ['10.0.1.100', '10.0.1.100', 's1-eth1', '10.0.1.1', 1],
                              ['10.0.2.100', '10.0.2.100','s1-eth2', '10.0.2.1', 2],
                              ['10.0.3.100', '10.0.3.100', 's1-eth3', '10.0.5.1', 3],
                              ['10.0.5.100','10.0.5.2','s1-eth3','10.0.5.2',3]]
    
    self.routingTable[2] = [ ['10.0.1.100', '10.0.1.100', 's2-eth3', '10.0.5.2', 4],
                              ['10.0.2.100', '10.0.2.100', 's2-eth3', '10.0.5.2', 4],
                              ['10.0.3.100', '10.0.3.100', 's2-eth1', '10.0.3.1', 5],
                              ['10.0.5.100','10.0.5.1','s2-eth3','10.0.5.1',6]]
    """
